...
var vtprotoPool_Response = sync.Pool{
	New: func() interface{} {
		return &Response{}
	},
}

func (m *Response) ResetVT() {
	if m != nil {
		m.Reset()
	}
}
func (m *Response) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_Response.Put(m)
	}
}
func ResponseFromVTPool() *Response {
	return vtprotoPool_Response.Get().(*Response)
}
